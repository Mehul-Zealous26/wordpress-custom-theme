<?php
$project_slides = get_sub_field('project_slides');
$project_listing_title = get_sub_field('project_listing_title');
$project_listing_description = get_sub_field('project_listing_description');
    ...
    <div class="main-banner-swiper swiper">
        <div class="swiper-wrapper">
            <?php if ($project_slides): ?>
                <?php foreach ($project_slides as $project): ?>
                    <?php
                    ...
                    <div class="banner-slider swiper-slide">
                        <img class="banner-slider-img" src="<?php echo esc_url($project_image); ?>"
                            alt="<?php echo esc_attr($project_title); ?>">
                        <div class="project-banner-cont">
                            <h1><?php echo esc_html($project_title); ?></h1>
                            <div class="banner-btn">
                                <a href="<?php echo esc_url($project_url); ?>" class="btn secondary-btn double-right-btn">View
                                    Project<img
                        ...
                        <div class="project-banner-info">
                            ...
                            if ($locations && !is_wp_error($locations)) {
                                ...
                                $company_name_value = get_field('company_name_value', $project_id);
                                ?>
                                <label><?php echo esc_html($company_name_value); ?></label>
...
<section class="project-section" <?php if ($padding_style)
    ...
    <div class="container-box" id="project-container">
        <div class="sub-title-with-text w-600 text-content-section">
            <?php echo ($project_listing_title); ?>
            <?php echo ($project_listing_description); ?>
        </div>
        <div class="product-list-filter-section filter-section-border">
            <div class="plf-section-left">
                <div class="filter-btn-main">
                    <a href="javascript:void(0)" class="btn btn-sm gray-btn projects-filter-btn">
                    ...
                    <a href="javascript:void(0)" class="btn btn-xxs gray-btn reset-project-btn" style="display: none;">
                        Reset <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/close-icon.svg"
                            alt="close Image">
                    </a>
                </div>
                <div class="item-count" id="projects-item-count">Loading...</div>
            </div>
        ...
        <div class="pdf-filter-box">
            <div class="pdf-filter-list projects-attr">
                ...
                <div class="pdf-filter-accordion-main">
                    <div class="pdf-filter-accordion-box">
                        <div class="pdf-filter-accordion-head">
                            Product categories <span class="filter-count">[0]</span> <i><img
                        ...
                        <div class="pdf-filter-accordion-body">
                            <div class="pdf-filter-accordion-inner" id="projects-product-categories-filter">
                    ...
                    <div class="pdf-filter-accordion-box">
                        ...
                        <div class="pdf-filter-accordion-body">
                            <div class="pdf-filter-accordion-inner" id="projects-applications-filter">
                    ...
                    <div class="pdf-filter-accordion-box">
                        <div class="pdf-filter-accordion-head">
                            Locations <span class="locations-count">[0]</span> <i><img
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/accordion-arrow.svg"
                                    alt="Accordion Arrow"></i>
                        </div>
                        <div class="pdf-filter-accordion-body">
                            <div class="pdf-filter-accordion-inner" id="locations-filter">
                ...
                <div class="reset-btn-mobile-wrapper">
                    <a href="javascript:void(0)" class="btn secondary-btn" id="clear-project-btn-mobile">
                        Clear filters
                    </a>
                    <a href="javascript:void(0)" class="pdf-filter-close btn primary-btn">Show Results</a>
                </div>
            </div>
            <div class="project-section-main" id="projects-list">
                <!-- Projects will be loaded here -->
            </div>
        </div>
        <div class="pagi-main projects-pagination" id="projects-pagination">
            <div class="pagi-row">
                <!-- Projects pagination will be loaded here -->
            </div>
        </div>
    </div>
</section>